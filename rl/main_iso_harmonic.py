...
if __name__ == "__main__":
    ...
    parser.add_argument("--policy_name", default="iso-harmonic-TD3")            # Policy name
    ...
    if args.pixels:
        ...
        model = torch.load(model_path).cuda("cuda:1").eval()
    ...
    elif args.policy_name == "iso-harmonic-TD3":
        # `decoder` decodes DynE actions into sequences of raw actions
        decoder_path = "../embedding/results/{}/{}/decoder_iso_harmonic.pt".format(source_env, args.decoder)

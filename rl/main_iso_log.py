...
if __name__ == "__main__":
    ...
    parser.add_argument("--policy_name", default="iso-log-TD3")            # Policy name
    ...
    elif args.policy_name == "iso-log-TD3":
        # `decoder` decodes DynE actions into sequences of raw actions
        decoder_path = "../embedding/results/{}/{}/decoder_iso_log.pt".format(source_env, args.decoder)
